...
user_pref("browser.discovery.enabled", false); // Disable personalized extension recommendations
...
user_pref("browser.newtabpage.activity-stream.default.sites", ""); // No default sites, unless you add them yourself
...
user_pref("browser.newtabpage.activity-stream.showSponsored", false); // FF58+, just say 'No'
user_pref("browser.newtabpage.activity-stream.showSponsoredCheckboxes", false); // Choose to support, or not, Mozilla
...
user_pref("browser.privatebrowsing.forceMediaMemoryCache", true); // Set media cache in Private Browsing to in-memory, size set below; Firefox 75+
...
user_pref("browser.urlbar.addons.featureGate", false); // Firefox 115+
user_pref("browser.urlbar.amp.featureGate", false); // Firefox Ad-Marketplace, Firefox 141+
user_pref("browser.urlbar.fakespot.featureGate", false); // Firefox 130+
...
user_pref("browser.urlbar.mdn.featureGate", false); // Firefox 117+
user_pref("browser.urlbar.quicksuggest.enabled", false); // Firefox 92+
...
user_pref("browser.urlbar.suggest.quicksuggest.nonsponsored", false); // Firefox 95+
...
user_pref("browser.urlbar.trending.featureGate", false); // Don't suggest trending searches
user_pref("browser.urlbar.trimURLS", false); // Do not trim HTTP off URLs in the address bar
user_pref("browser.urlbar.weather.featureGate", false); // I don't want Firefox using geoclue2
user_pref("browser.urlbar.wikipedia.featureGate", false); // Firefox 141+
user_pref("browser.urlbar.yelp.featureGate", false); // Firefox 124+
user_pref("browser.xul.error_pages.expert_bad_cert", true); // Advanced info on Insecure Warning pages

// AI Specific
user_pref("browser.ml.enable", false); // I do not ever want an AI browser
user_pref("browser.ml.chat.enabled", false); // If I want to chat with AI, I will do it on my own terms
user_pref("browser.ml.chat.page.footerBadge", false);
user_pref("browser.ml.chat.page.menuBadge", false);
user_pref("browser.ml.linkPreview.enabled", false); // I don't need AI watching every website I visit
user_pref("browser.tabs.groups.smart.enabled", false); // Stop AI from creating tab groups
user_pref("browser.tabs.groups.smart.userEnabled", false); // More AI slop
user_pref("extensions.ml.enabled", false); // Just no, it's getting tiresome now
user_pref("sidebar.notification.badge.aichat", false); // *sigh*
...
user_pref("media.memory_cache_max_size", 65536); // See pref: browser.privatebrowsing.forceMediaMemoryCache above, Firefox 75+
...
// Miscellaneous
user_pref("app.normandy.enabled", false); // Forget telemetry pings
...
user_pref("captivedetect.canonicalURL", ""); // See: https://www.eff.org/deeplinks/2017/08/how-captive-portals-interfere-wireless-security-and-privacy
